...
public class AuthController {
    ...
    public ResponseEntity sessionLogin(@RequestParam("email") String e, @RequestParam("password") String p, HttpSession session) {
    ...
    public ResponseEntity findYourInfo(HttpServletRequest request) {
        ...
        BearerAuthorizationExtractor bearerAuthorizationExtractor = new BearerAuthorizationExtractor();
    ...
    public ResponseEntity findMyInfo(HttpServletRequest request) {
        ...
        AuthInfo extract = basicAuthorizationExtractor.extract(request);
